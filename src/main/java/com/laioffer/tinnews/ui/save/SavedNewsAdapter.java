...
//recyclerView is a subclass of ViewGroup -> itemView
    //Adapter -> viewHolder(itemView)每个itemview是怎么创建的，怎么bind的，一共有多少个item
...
//如何删除呢？按照mvvm的思想，删除应该放在view里面，也就是saveFragment，也就是这里的onBindViewHolder
    //提供一个删除的接口，这样就把删除和saveFragment，adapter，viewmodel解耦合了，以后谁想删除，就把interface
    //实现好了，call我的这个interface就行，而不是得需要知道莫表fragment的所有信息
