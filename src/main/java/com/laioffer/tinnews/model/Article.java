...
public class Article implements Serializable {
    //we plan to save the article to Room and we already have Article,
    // we could just simply modify the Article class by adding Room annotations.
    //variable names of properties need to be the same with what listed in https://newsapi.org/
    ...
    @PrimaryKey
    @NonNull
    public String url;//unique value, as primary key
